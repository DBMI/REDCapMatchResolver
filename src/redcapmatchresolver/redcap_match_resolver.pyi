...
class REDCapMatchResolver:
    ...
    __database_fields_list: list = ...
    __dataframe_fields_list: list = ...
    __log: Logger = ...
    __redcap_reader: REDCapReportReader = ...
    __redcap_writer: REDCapReportWriter = ...

    def __init__(
        self, log: Logger, connection: sqlite3.Connection | None = ...
    ) -> None: ...
